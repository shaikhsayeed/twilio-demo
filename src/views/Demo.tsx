...
class App extends React.Component<any, any> {
    ...
    getTwillioToken = () => {
        ...
        axios.get(`https://www.feelitlive.com/api/video/token/${window.location.search.replace("?", "")}/cool%20room`).then(results => {
            this.setState(
                {
    ...
    roomJoined(room) {
        ...
        var previewContainer: any = this.refs.groupChat_localMedia;
                        ...
                        <div className="row">
                            <div className="col-3 form-inline">
                                <div className="form-group mt-2">
                                    <input className="form-control" onChange={(e) => this.setState({ userName: e.target.value })} type="text" ref="yourname" value={this.state.userName} />  {joinOrLeaveRoomButton}
                                </div>
                            </div>
                        </div>
                    }
                            ...
                            <div className="card">
                                <div className="card-body">
                                    ...
                                    <div className="text-center">
                                        {!this.state.hasJoinedRoom && <>Loading....</>}
                                    </div>
                                </div>
                        ...
                        <div className="col-6">
                            <div className="card">
                                <div className="card-body">
                                    ...
                                    <div className="text-center">
                                        {!this.state.hasParticipantsJoinedRoom && !this.state.peerIdentity && <>Loading....</>}
                                    </div>
                                </div>
